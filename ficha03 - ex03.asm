	...
	mov	dl,10	; dl recebe o valor do contador. s�o 16 elementos
soma:	mov	[cl],al	; valor de al ser� armazenado no endere�o indicado em cl
	add	al,02	
	...
	mov	dl,0f	; contador agora s�o s� 15 elementos
xorr:	mov	bl,[cl]	;leio proximo valor
	xor	al,bl	;fa�o xor entreles, al ir� acumular o resultado
	inc	cl	; cl aponta para proximo elemento
	dec	dl	; decremento contador
	jnz	xorr	; dl chegou a zero? sen�o faz proximo xor
